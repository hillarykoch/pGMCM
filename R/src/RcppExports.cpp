...
RcppExport SEXP _pGMCM_creduce_by_hamming(SEXP red_classSEXP, SEXP fullidxSEXP, SEXP hamming_tolSEXP, SEXP MSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type red_class(red_classSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_pGMCM_creduce_by_hamming", (DL_FUNC) &_pGMCM_creduce_by_hamming, 4},
