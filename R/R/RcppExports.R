...
cgetPaths <- function(filepath, len_filt_h, nonconsec, mus, labels, n, dist_tol) {
    .Call(`_pGMCM_cgetPaths`, filepath, len_filt_h, nonconsec, mus, labels, n, dist_tol)
}
...
cassociate <- function(path, filepath, len_filt_h) {
    .Call(`_pGMCM_cassociate`, path, filepath, len_filt_h)
}
